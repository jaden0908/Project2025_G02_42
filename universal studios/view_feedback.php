...
/* ===========================================================
   ...
   - Export CSV
   - Same sidebar & design as dashboard (style.css)
   =========================================================== */
...
/* Keyword filter: search in message, guest_name, guest_email */
if ($q !== '') {
...
<head>
  <meta charset="utf-8">
  <title><?= BRAND_NAME ?> · View Feedback</title>
  ...
  <main class="main">
    ...
    <form class="row g-2 mb-3" method="get">
      ...
      <div class="col-md-12 text-end">
        ...
        <a href="view_feedback.php?export=csv" class="btn btn-outline-secondary btn-pill"><i class="bi bi-download me-1"></i>Export CSV</a>
      </div>
    </form>
    ...
    <div class="card-soft p-3">
      ...
      <nav>
        <ul class="pagination pagination-sm justify-content-end">
          <?php
          $base = 'view_feedback.php?q='.urlencode($q).'&rating='.urlencode($rating).'&role='.urlencode($roleSnap).'&package='.urlencode($pkg).'&from='.urlencode($from).'&to='.urlencode($to).'&page=';
    ...
    <div class="text-center text-muted small mt-4">© <?= date('Y') ?> <?= BRAND_NAME ?> · View Feedback</div>
  </main>
</div>
