...
<head>
    ...
    <meta content="<?= BRAND_NAME ?> contact, support, address, phone, email" name="keywords">
    <meta content="Get in touch with <?= BRAND_NAME ?> — questions about tickets, parks, or support." name="description">
...
<div class="container-fluid nav-bar sticky-top px-4 py-2 py-lg-0">
    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="package.php" class="btn btn-primary rounded-pill py-2 px-4 flex-shrink-0">Get Started</a>
        </div>
    </nav>
</div>
<!-- Navbar End -->
...
<div class="container-fluid contact py-5">
    <div class="container py-5">
        ...
        <div class="text-center pb-4 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <p class="mb-0">Reach us via the channels below—our team is happy to help.</p>
        </div>

        <!-- Contact cards (no form, no social icons) -->
        <div class="row g-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="col-lg-3 col-md-6">
                <div class="contact-add-item rounded bg-light p-4 h-100 text-center">
                    <div class="contact-icon text-primary mb-3">
                        <i class="fas fa-map-marker-alt fa-2x"></i>
                    </div>
                    <h5>Address</h5>
                    <p class="mb-0">123 Studio Drive, Orlando, USA</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="contact-add-item rounded bg-light p-4 h-100 text-center">
                    ...
                    <h5>Email</h5>
                    <p class="mb-0">support@universalstudios.com</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="contact-add-item rounded bg-light p-4 h-100 text-center">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="contact-add-item rounded bg-light p-4 h-100 text-center">
                    ...
                    <h5>Website</h5>
                    <p class="mb-0">universalstudios.com</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <p class="text-white mb-0">123 Studio Drive, Orlando, USA</p>
                    </div>
                    <div class="d-flex align-items-center">
                        <i class="fas fa-envelope text-primary me-3"></i>
                        <p class="text-white mb-0">support@universalstudios.com</p>
                    </div>
                    <div class="d-flex align-items-center">
