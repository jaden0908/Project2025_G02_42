...
<head>
    <meta charset="utf-8">
    <title><?= BRAND_NAME ?> - Services</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="<?= BRAND_NAME ?> services, express pass, dining, lockers, studio tours" name="keywords">
    <meta content="Discover services at <?= BRAND_NAME ?> including Express Pass, themed dining, secure lockers, and studio experiences." name="description">
   ...
   <script src="https://kit.fontawesome.com/351048854e.js" crossorigin="anonymous"></script>
    ...
    <style>
  .bg-breadcrumb { margin-bottom: 0 !important; }
  .container-fluid.service { margin-top: 0 !important; }
</style>
...
<div class="container-fluid service py-5">
  <div class="container service-section py-5">
    <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
      ...
      <p class="mb-0 text-white">From Express Pass to themed dining and secure locker rentals, enjoy a smooth, movie-magic day at the park.</p>
    </div>
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="service-item p-4">
                    <div class="service-content">
                        ...
                        <a href="#" class="h4 d-inline-block mb-3">Express Pass</a>
                        <p class="mb-0">Skip regular lines on select attractions to maximize your day.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="service-item p-4">
                    <div class="service-content">
                        ...
                        <a href="#" class="h4 d-inline-block mb-3">Themed Dining</a>
                        <p class="mb-0">Enjoy restaurants and snacks inspired by blockbuster worlds.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="service-item p-4">
                    <div class="service-content">
                        ...
                        <a href="#" class="h4 d-inline-block mb-3">Secure Lockers</a>
                        <p class="mb-0">Convenient lockers near major rides to keep your items safe.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                <div class="service-item p-4">
                    <div class="service-content">
                        ...
                        <a href="#" class="h4 d-inline-block mb-3">Studio Experiences</a>
                        <p class="mb-0">Interactive zones, character meets and behind-the-scenes fun.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid testimonial py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            ...
            <p class="text-white mb-0">Real reviews from visitors who enjoyed a day of movie-magic thrills.</p>
        </div>
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
            <div class="testimonial-item p-4">
                <p class="text-white fs-4 mb-4">Best theme park day ever—Express Pass saved so much time and the shows were incredible!</p>
                <div class="testimonial-inner">
                    ...
                    <div class="ms-4">
                        <h4>Alex</h4>
                        <p class="text-start text-white">Family Traveler</p>
            ...
            <div class="testimonial-item p-4">
                <p class="text-white fs-4 mb-4">Loved the themed dining and character meet-ups—kids had a blast!</p>
                <div class="testimonial-inner">
                    <div class="testimonial-img">
                    ...
                    <div class="ms-4">
                        <h4>Sophia</h4>
                        <p class="text-start text-white">Parent</p>
                        <div class="d-flex text-primary">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star text-white"></i>
                        </div>
                    </div>
            ...
            <div class="testimonial-item p-4">
                <p class="text-white fs-4 mb-4">Lockers were super convenient and the stunt show blew my mind.</p>
                <div class="testimonial-inner">
                    <div class="testimonial-img">
                    ...
                    <div class="ms-4">
                        <h4>Marcus</h4>
                        <p class="text-start text-white">Theme Park Fan</p>
                        <div class="d-flex text-primary">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star text-white"></i>
                        </div>
                    </div>
