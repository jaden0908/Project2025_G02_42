                    ...
                    <div class="row g-5 align-items-center">
                        <div class="col-xl-7 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s" style="animation-delay: 1s;">
                            <div class="text-start">
                                ...
                                <p class="mb-4 fs-5">Step into worlds from your favorite films and shows—thrilling coasters, immersive lands, spectacular entertainment, all in one place.
                                </p>
                    ...
                    <div class="row g-5 align-items-center">
                        <div class="col-xl-7 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s" style="animation-delay: 1s;">
                            <div class="text-start">
                                ...
                                <p class="mb-4 fs-5">From high-speed adventures to family-friendly fun, discover entertainment inspired by global blockbusters.
                                </p>
                                <div class="d-flex flex-shrink-0">
                                    <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="package.php">Our Packages</a>
                                </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-content p-4">
                            <div class="feature-content-inner">
                                ...
                                <p class="text-white">Feel the rush on attractions inspired by your favorite films and characters.
                                </p>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-content p-4">
                            <div class="feature-content-inner">
                                ...
                                <p class="text-white">Stunt shows, parades, and live performances bring stories to life.
                                </p>
                                <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More <i class="fa fa-arrow-right ms-1"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="feature-item">
                        ...
                        <div class="feature-content p-4">
                            <div class="feature-content-inner">
                                ...
                                <p class="text-white">Behind-the-scenes touches, immersive lands, and photo-worthy sets.
                                </p>
                                <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More <i class="fa fa-arrow-right ms-1"></i></a>
                            </div>
                        </div>
            ...
            <div class="row g-5">
                <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div>
                        ...
                        <p class="mb-5">From high-octane coasters to immersive lands and family attractions, <?= BRAND_NAME ?> brings movie magic to life with world-class entertainment, dining and experiences.
                        </p>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="d-flex">
    ...
    <div class="container-fluid service py-5">
        <div class="container service-section py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <p class="mb-0 text-white">Plan your perfect day with convenient hours, dining options, lockers, rentals, and more guest services across the park.
                </p>
            </div>
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="service-item p-4">
                        <div class="service-content">
                            ...
                            <p class="mb-0">Reserve cozy spaces to relax between rides and shows.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="service-item p-4">
                        <div class="service-content">
                            ...
                            <p class="mb-0">Tasty bites and themed restaurants throughout the park.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="service-item p-4">
                        <div class="service-content">
                            ...
                            <p class="mb-0">Secure storage for your belongings near major attractions.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="service-item p-4">
                        <div class="service-content">
                            ...
                            <p class="mb-0">Upgrade options to reduce wait times at select rides.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="packages-item h-100">
                        ...
                        <p class="mb-4">Save with bundles and seasonal offers. Plan ahead to get the most out of your day at <?= BRAND_NAME ?>.
                        </p>
                        ...
                        <p class="mb-5"><i class="fa fa-check text-primary me-2"></i>Win up to 3 free day tickets</p>
                        <a href="package.php" class="btn btn-primary rounded-pill py-3 px-5"> Book Now</a>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="pricing-item bg-dark rounded text-center p-5 h-100">
                        <div class="pb-4 border-bottom">
                            ...
                            <p class="mb-4">Admission for the whole crew plus select perks.</p>
                            <h2 class="mb-0 text-primary">$260,90<span class="text-body fs-5 fw-normal">/family</span></h2>
                        </div>
                        <div class="py-4">
                            <p class="mb-4"><i class="fa fa-check text-primary me-2"></i>Park-wide access</p>
                            <p class="mb-4"><i class="fa fa-check text-primary me-2"></i>Reserved lounge area</p>
                            <p class="mb-4"><i class="fa fa-check text-primary me-2"></i>Complimentary drinks</p>
                            <p class="mb-4"><i class="fa fa-check text-primary me-2"></i>Locker credits</p>
                            <p class="mb-4"><i class="fa fa-check text-primary me-2"></i>Souvenir towels</p>
                        </div>
                        <a href="package.php" class="btn btn-light rounded-pill py-3 px-5"> Book Now</a>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="pricing-item bg-primary rounded text-center p-5 h-100">
                        <div class="pb-4 border-bottom">
                            ...
                            <p class="text-white mb-4">Perfect for a quick visit with essential access.</p>
                            <h2 class="text-dark mb-0">$60,90<span class="text-white fs-5 fw-normal">/person</span></h2>
                        </div>
                        <div class="text-white py-4">
                            <p class="mb-4"><i class="fa fa-check text-dark me-2"></i>Admission ticket</p>
                            <p class="mb-4"><i class="fa fa-check text-dark me-2"></i>Soft drink</p>
                            <p class="mb-4"><i class="fa fa-check text-dark me-2"></i>Locker access</p>
                            <p class="mb-4"><i class="fa fa-check text-dark me-2"></i>Souvenir</p>
                        </div>
                        <a href="package.php" class="btn btn-dark rounded-pill py-3 px-5"> Book Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid attractions py-5">
        <div class="container attractions-section py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <p class="text-white mb-0">High-speed coasters, immersive lands, and family favorites—all inspired by hit movies and TV series.
                </p>
            </div>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="blog-item">
                        ...
                        <div class="blog-content p-4">
                            ...
                            <p class="mb-4">Plan your route, use Express upgrades, and catch the must-see shows without rushing….
                            </p>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="blog-item">
                        ...
                        <div class="blog-content p-4">
                            ...
                            <p class="mb-4">From gentle rides to character meet-ups, here’s where families love to spend time….
                            </p>
                            <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More <i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="blog-item">
                        ...
                        <div class="blog-content p-4">
                            ...
                            <p class="mb-4">Crowd patterns, weather tips, and seasonal events to help you pick your date….
                            </p>
                            <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More <i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
    ...
    <div class="container-fluid team pb-5">
        <div class="container pb-5">
            ...
            <div class="row g-4 justify-content-center">
                <!-- Cards unchanged, only copy adjusted above -->
                <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="team-item p-4">
                        <div class="team-content">
                            ...
                            <p class="text-center mb-0">Focused on guest experience and operational excellence across the park.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="team-item p-4">
                        <div class="team-content">
                            ...
                            <p class="text-center mb-0">Leads live entertainment with stunts, music, and crowd-pleasing spectacles.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item p-4">
                        <div class="team-content">
                            ...
                            <p class="text-center mb-0">Ensures safety and thrills on our headline rides and family favorites.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid testimonial py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <p class="text-white mb-0">Real stories from visitors who experienced movie magic at <?= BRAND_NAME ?>.
                </p>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
                <!-- cards unchanged (copy adjusted) -->
